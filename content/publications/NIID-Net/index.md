...
summary: TVCG 2020. We propose NIID-Net, a novel learning-based framework that adapts surface normal knowledge for improving the decomposition.
...
image:
  caption: 'Two samples from an edited image sequence'
  focal_point: small
  preview_only: false
